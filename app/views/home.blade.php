...
<div class="jumbotron margin-top">
    ...
    <div class="current-status">
        ...
        <p>At the moment the phone is <span id="not-running"></span> running <strong id="popover" data-content="Blablablabla" role="button" data-placement="right" data-original-title="Current Test">this</strong> test and is <strong id="not-charging">not</strong> charging.</p>
        ...
        <p>Otherwise you could <a href="javascript:newTest()">create some more</a> or <a href="/charts">look at the results</a></p>
    </div>
